// DE10_standard_hps_partial_reconfiguration_mm_interconnect_3.v
...
`timescale 1 ps / 1 ps
module DE10_standard_hps_partial_reconfiguration_mm_interconnect_3 (
		...
		input  wire         sdram_master_clk_reset_reset_bridge_in_reset_reset,                 //                 sdram_master_clk_reset_reset_bridge_in_reset.reset
		input  wire         sdram_master_master_translator_reset_reset_bridge_in_reset_reset,   //   sdram_master_master_translator_reset_reset_bridge_in_reset.reset
		input  wire [31:0]  sdram_master_master_address,                                        //                                          sdram_master_master.address
		output wire         sdram_master_master_waitrequest,                                    //                                                             .waitrequest
		input  wire [3:0]   sdram_master_master_byteenable,                                     //                                                             .byteenable
		input  wire         sdram_master_master_read,                                           //                                                             .read
		output wire [31:0]  sdram_master_master_readdata,                                       //                                                             .readdata
		output wire         sdram_master_master_readdatavalid,                                  //                                                             .readdatavalid
		input  wire         sdram_master_master_write,                                          //                                                             .write
		input  wire [31:0]  sdram_master_master_writedata,                                      //                                                             .writedata
	...
	wire          sdram_master_master_translator_avalon_universal_master_0_waitrequest;   // sdram_master_master_agent:av_waitrequest -> sdram_master_master_translator:uav_waitrequest
	wire   [31:0] sdram_master_master_translator_avalon_universal_master_0_readdata;      // sdram_master_master_agent:av_readdata -> sdram_master_master_translator:uav_readdata
	wire          sdram_master_master_translator_avalon_universal_master_0_debugaccess;   // sdram_master_master_translator:uav_debugaccess -> sdram_master_master_agent:av_debugaccess
	wire   [31:0] sdram_master_master_translator_avalon_universal_master_0_address;       // sdram_master_master_translator:uav_address -> sdram_master_master_agent:av_address
	wire          sdram_master_master_translator_avalon_universal_master_0_read;          // sdram_master_master_translator:uav_read -> sdram_master_master_agent:av_read
	wire    [3:0] sdram_master_master_translator_avalon_universal_master_0_byteenable;    // sdram_master_master_translator:uav_byteenable -> sdram_master_master_agent:av_byteenable
	wire          sdram_master_master_translator_avalon_universal_master_0_readdatavalid; // sdram_master_master_agent:av_readdatavalid -> sdram_master_master_translator:uav_readdatavalid
	wire          sdram_master_master_translator_avalon_universal_master_0_lock;          // sdram_master_master_translator:uav_lock -> sdram_master_master_agent:av_lock
	wire          sdram_master_master_translator_avalon_universal_master_0_write;         // sdram_master_master_translator:uav_write -> sdram_master_master_agent:av_write
	wire   [31:0] sdram_master_master_translator_avalon_universal_master_0_writedata;     // sdram_master_master_translator:uav_writedata -> sdram_master_master_agent:av_writedata
	wire    [2:0] sdram_master_master_translator_avalon_universal_master_0_burstcount;    // sdram_master_master_translator:uav_burstcount -> sdram_master_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                      // rsp_mux:src_valid -> sdram_master_master_agent:rp_valid
	wire  [111:0] rsp_mux_src_data;                                                       // rsp_mux:src_data -> sdram_master_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                      // sdram_master_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                    // rsp_mux:src_channel -> sdram_master_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                              // rsp_mux:src_startofpacket -> sdram_master_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                // rsp_mux:src_endofpacket -> sdram_master_master_agent:rp_endofpacket
	...
	wire          sdram_master_master_agent_cp_valid;                                     // sdram_master_master_agent:cp_valid -> router:sink_valid
	wire  [111:0] sdram_master_master_agent_cp_data;                                      // sdram_master_master_agent:cp_data -> router:sink_data
	wire          sdram_master_master_agent_cp_ready;                                     // router:sink_ready -> sdram_master_master_agent:cp_ready
	wire          sdram_master_master_agent_cp_startofpacket;                             // sdram_master_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          sdram_master_master_agent_cp_endofpacket;                               // sdram_master_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	) sdram_master_master_translator (
		.clk                    (Clock_clk_clk),                                                          //                       clk.clk
		.reset                  (sdram_master_master_translator_reset_reset_bridge_in_reset_reset),       //                     reset.reset
		.uav_address            (sdram_master_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (sdram_master_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (sdram_master_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (sdram_master_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (sdram_master_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (sdram_master_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (sdram_master_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (sdram_master_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (sdram_master_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (sdram_master_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (sdram_master_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (sdram_master_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (sdram_master_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (sdram_master_master_byteenable),                                         //                          .byteenable
		.av_read                (sdram_master_master_read),                                               //                          .read
		.av_readdata            (sdram_master_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (sdram_master_master_readdatavalid),                                      //                          .readdatavalid
		.av_write               (sdram_master_master_write),                                              //                          .write
		.av_writedata           (sdram_master_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) sdram_master_master_agent (
		.clk                   (Clock_clk_clk),                                                          //       clk.clk
		.reset                 (sdram_master_master_translator_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.av_address            (sdram_master_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (sdram_master_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (sdram_master_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (sdram_master_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (sdram_master_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (sdram_master_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (sdram_master_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (sdram_master_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (sdram_master_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (sdram_master_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (sdram_master_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (sdram_master_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (sdram_master_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (sdram_master_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (sdram_master_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (sdram_master_master_agent_cp_ready),                                     //          .ready
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_3_router router (
		.sink_ready         (sdram_master_master_agent_cp_ready),                               //      sink.ready
		.sink_valid         (sdram_master_master_agent_cp_valid),                               //          .valid
		.sink_data          (sdram_master_master_agent_cp_data),                                //          .data
		.sink_startofpacket (sdram_master_master_agent_cp_startofpacket),                       //          .startofpacket
		.sink_endofpacket   (sdram_master_master_agent_cp_endofpacket),                         //          .endofpacket
		.clk                (Clock_clk_clk),                                                    //       clk.clk
		.reset              (sdram_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_3_router_001 router_001 (
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_3_cmd_demux cmd_demux (
		.clk                (Clock_clk_clk),                                                    //       clk.clk
		.reset              (sdram_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_3_cmd_mux cmd_mux (
		.clk                 (Clock_clk_clk),                                                      //       clk.clk
		.reset               (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_3_cmd_demux rsp_demux (
		.clk                (Clock_clk_clk),                                                      //       clk.clk
		.reset              (hps_0_f2h_sdram0_data_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_3_rsp_mux rsp_mux (
		.clk                 (Clock_clk_clk),                                                    //       clk.clk
		.reset               (sdram_master_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_3_avalon_st_adapter #(
		.inBitsPerSymbol (258),
		.inUsePackets    (0),
		.inDataWidth     (258),
		.inChannelWidth  (0),
