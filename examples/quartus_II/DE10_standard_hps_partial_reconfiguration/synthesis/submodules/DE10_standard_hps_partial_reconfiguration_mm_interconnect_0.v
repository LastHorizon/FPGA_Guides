// DE10_standard_hps_partial_reconfiguration_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module DE10_standard_hps_partial_reconfiguration_mm_interconnect_0 (
		...
		input  wire        alt_pr_0_nreset_reset_bridge_in_reset_reset,                         //                         alt_pr_0_nreset_reset_bridge_in_reset.reset
		...
		output wire [0:0]  alt_pr_0_avmm_slave_address,                                         //                                           alt_pr_0_avmm_slave.address
		output wire        alt_pr_0_avmm_slave_write,                                           //                                                              .write
		output wire        alt_pr_0_avmm_slave_read,                                            //                                                              .read
		input  wire [15:0] alt_pr_0_avmm_slave_readdata,                                        //                                                              .readdata
		output wire [15:0] alt_pr_0_avmm_slave_writedata,                                       //                                                              .writedata
		input  wire        alt_pr_0_avmm_slave_waitrequest,                                     //                                                              .waitrequest
		output wire [8:0]  mm_bridge_0_s0_address,                                              //                                                mm_bridge_0_s0.address
	...
	wire   [15:0] alt_pr_0_avmm_slave_agent_m0_readdata;                    // alt_pr_0_avmm_slave_translator:uav_readdata -> alt_pr_0_avmm_slave_agent:m0_readdata
	wire          alt_pr_0_avmm_slave_agent_m0_waitrequest;                 // alt_pr_0_avmm_slave_translator:uav_waitrequest -> alt_pr_0_avmm_slave_agent:m0_waitrequest
	wire          alt_pr_0_avmm_slave_agent_m0_debugaccess;                 // alt_pr_0_avmm_slave_agent:m0_debugaccess -> alt_pr_0_avmm_slave_translator:uav_debugaccess
	wire   [20:0] alt_pr_0_avmm_slave_agent_m0_address;                     // alt_pr_0_avmm_slave_agent:m0_address -> alt_pr_0_avmm_slave_translator:uav_address
	wire    [1:0] alt_pr_0_avmm_slave_agent_m0_byteenable;                  // alt_pr_0_avmm_slave_agent:m0_byteenable -> alt_pr_0_avmm_slave_translator:uav_byteenable
	wire          alt_pr_0_avmm_slave_agent_m0_read;                        // alt_pr_0_avmm_slave_agent:m0_read -> alt_pr_0_avmm_slave_translator:uav_read
	wire          alt_pr_0_avmm_slave_agent_m0_readdatavalid;               // alt_pr_0_avmm_slave_translator:uav_readdatavalid -> alt_pr_0_avmm_slave_agent:m0_readdatavalid
	wire          alt_pr_0_avmm_slave_agent_m0_lock;                        // alt_pr_0_avmm_slave_agent:m0_lock -> alt_pr_0_avmm_slave_translator:uav_lock
	wire   [15:0] alt_pr_0_avmm_slave_agent_m0_writedata;                   // alt_pr_0_avmm_slave_agent:m0_writedata -> alt_pr_0_avmm_slave_translator:uav_writedata
	wire          alt_pr_0_avmm_slave_agent_m0_write;                       // alt_pr_0_avmm_slave_agent:m0_write -> alt_pr_0_avmm_slave_translator:uav_write
	wire    [1:0] alt_pr_0_avmm_slave_agent_m0_burstcount;                  // alt_pr_0_avmm_slave_agent:m0_burstcount -> alt_pr_0_avmm_slave_translator:uav_burstcount
	wire          alt_pr_0_avmm_slave_agent_rf_source_valid;                // alt_pr_0_avmm_slave_agent:rf_source_valid -> alt_pr_0_avmm_slave_agent_rsp_fifo:in_valid
	wire   [94:0] alt_pr_0_avmm_slave_agent_rf_source_data;                 // alt_pr_0_avmm_slave_agent:rf_source_data -> alt_pr_0_avmm_slave_agent_rsp_fifo:in_data
	wire          alt_pr_0_avmm_slave_agent_rf_source_ready;                // alt_pr_0_avmm_slave_agent_rsp_fifo:in_ready -> alt_pr_0_avmm_slave_agent:rf_source_ready
	wire          alt_pr_0_avmm_slave_agent_rf_source_startofpacket;        // alt_pr_0_avmm_slave_agent:rf_source_startofpacket -> alt_pr_0_avmm_slave_agent_rsp_fifo:in_startofpacket
	wire          alt_pr_0_avmm_slave_agent_rf_source_endofpacket;          // alt_pr_0_avmm_slave_agent:rf_source_endofpacket -> alt_pr_0_avmm_slave_agent_rsp_fifo:in_endofpacket
	wire          alt_pr_0_avmm_slave_agent_rsp_fifo_out_valid;             // alt_pr_0_avmm_slave_agent_rsp_fifo:out_valid -> alt_pr_0_avmm_slave_agent:rf_sink_valid
	wire   [94:0] alt_pr_0_avmm_slave_agent_rsp_fifo_out_data;              // alt_pr_0_avmm_slave_agent_rsp_fifo:out_data -> alt_pr_0_avmm_slave_agent:rf_sink_data
	wire          alt_pr_0_avmm_slave_agent_rsp_fifo_out_ready;             // alt_pr_0_avmm_slave_agent:rf_sink_ready -> alt_pr_0_avmm_slave_agent_rsp_fifo:out_ready
	wire          alt_pr_0_avmm_slave_agent_rsp_fifo_out_startofpacket;     // alt_pr_0_avmm_slave_agent_rsp_fifo:out_startofpacket -> alt_pr_0_avmm_slave_agent:rf_sink_startofpacket
	wire          alt_pr_0_avmm_slave_agent_rsp_fifo_out_endofpacket;       // alt_pr_0_avmm_slave_agent_rsp_fifo:out_endofpacket -> alt_pr_0_avmm_slave_agent:rf_sink_endofpacket
	wire          alt_pr_0_avmm_slave_agent_rdata_fifo_src_valid;           // alt_pr_0_avmm_slave_agent:rdata_fifo_src_valid -> alt_pr_0_avmm_slave_agent_rdata_fifo:in_valid
	wire   [17:0] alt_pr_0_avmm_slave_agent_rdata_fifo_src_data;            // alt_pr_0_avmm_slave_agent:rdata_fifo_src_data -> alt_pr_0_avmm_slave_agent_rdata_fifo:in_data
	wire          alt_pr_0_avmm_slave_agent_rdata_fifo_src_ready;           // alt_pr_0_avmm_slave_agent_rdata_fifo:in_ready -> alt_pr_0_avmm_slave_agent:rdata_fifo_src_ready
	...
	wire          alt_pr_0_avmm_slave_agent_rp_valid;                       // alt_pr_0_avmm_slave_agent:rp_valid -> router_002:sink_valid
	wire   [93:0] alt_pr_0_avmm_slave_agent_rp_data;                        // alt_pr_0_avmm_slave_agent:rp_data -> router_002:sink_data
	wire          alt_pr_0_avmm_slave_agent_rp_ready;                       // router_002:sink_ready -> alt_pr_0_avmm_slave_agent:rp_ready
	wire          alt_pr_0_avmm_slave_agent_rp_startofpacket;               // alt_pr_0_avmm_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          alt_pr_0_avmm_slave_agent_rp_endofpacket;                 // alt_pr_0_avmm_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          alt_pr_0_avmm_slave_burst_adapter_source0_valid;          // alt_pr_0_avmm_slave_burst_adapter:source0_valid -> alt_pr_0_avmm_slave_agent:cp_valid
	wire   [93:0] alt_pr_0_avmm_slave_burst_adapter_source0_data;           // alt_pr_0_avmm_slave_burst_adapter:source0_data -> alt_pr_0_avmm_slave_agent:cp_data
	wire          alt_pr_0_avmm_slave_burst_adapter_source0_ready;          // alt_pr_0_avmm_slave_agent:cp_ready -> alt_pr_0_avmm_slave_burst_adapter:source0_ready
	wire    [1:0] alt_pr_0_avmm_slave_burst_adapter_source0_channel;        // alt_pr_0_avmm_slave_burst_adapter:source0_channel -> alt_pr_0_avmm_slave_agent:cp_channel
	wire          alt_pr_0_avmm_slave_burst_adapter_source0_startofpacket;  // alt_pr_0_avmm_slave_burst_adapter:source0_startofpacket -> alt_pr_0_avmm_slave_agent:cp_startofpacket
	wire          alt_pr_0_avmm_slave_burst_adapter_source0_endofpacket;    // alt_pr_0_avmm_slave_burst_adapter:source0_endofpacket -> alt_pr_0_avmm_slave_agent:cp_endofpacket
	...
	wire          router_002_src_valid;                                     // router_002:src_valid -> alt_pr_0_avmm_slave_rsp_width_adapter:in_valid
	wire   [93:0] router_002_src_data;                                      // router_002:src_data -> alt_pr_0_avmm_slave_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                     // alt_pr_0_avmm_slave_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                   // router_002:src_channel -> alt_pr_0_avmm_slave_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                             // router_002:src_startofpacket -> alt_pr_0_avmm_slave_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                               // router_002:src_endofpacket -> alt_pr_0_avmm_slave_rsp_width_adapter:in_endofpacket
	wire          alt_pr_0_avmm_slave_rsp_width_adapter_src_valid;          // alt_pr_0_avmm_slave_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [111:0] alt_pr_0_avmm_slave_rsp_width_adapter_src_data;           // alt_pr_0_avmm_slave_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          alt_pr_0_avmm_slave_rsp_width_adapter_src_ready;          // rsp_demux:sink_ready -> alt_pr_0_avmm_slave_rsp_width_adapter:out_ready
	wire    [1:0] alt_pr_0_avmm_slave_rsp_width_adapter_src_channel;        // alt_pr_0_avmm_slave_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          alt_pr_0_avmm_slave_rsp_width_adapter_src_startofpacket;  // alt_pr_0_avmm_slave_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          alt_pr_0_avmm_slave_rsp_width_adapter_src_endofpacket;    // alt_pr_0_avmm_slave_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> alt_pr_0_avmm_slave_cmd_width_adapter:in_valid
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> alt_pr_0_avmm_slave_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                        // alt_pr_0_avmm_slave_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> alt_pr_0_avmm_slave_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> alt_pr_0_avmm_slave_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> alt_pr_0_avmm_slave_cmd_width_adapter:in_endofpacket
	wire          alt_pr_0_avmm_slave_cmd_width_adapter_src_valid;          // alt_pr_0_avmm_slave_cmd_width_adapter:out_valid -> alt_pr_0_avmm_slave_burst_adapter:sink0_valid
	wire   [93:0] alt_pr_0_avmm_slave_cmd_width_adapter_src_data;           // alt_pr_0_avmm_slave_cmd_width_adapter:out_data -> alt_pr_0_avmm_slave_burst_adapter:sink0_data
	wire          alt_pr_0_avmm_slave_cmd_width_adapter_src_ready;          // alt_pr_0_avmm_slave_burst_adapter:sink0_ready -> alt_pr_0_avmm_slave_cmd_width_adapter:out_ready
	wire    [1:0] alt_pr_0_avmm_slave_cmd_width_adapter_src_channel;        // alt_pr_0_avmm_slave_cmd_width_adapter:out_channel -> alt_pr_0_avmm_slave_burst_adapter:sink0_channel
	wire          alt_pr_0_avmm_slave_cmd_width_adapter_src_startofpacket;  // alt_pr_0_avmm_slave_cmd_width_adapter:out_startofpacket -> alt_pr_0_avmm_slave_burst_adapter:sink0_startofpacket
	wire          alt_pr_0_avmm_slave_cmd_width_adapter_src_endofpacket;    // alt_pr_0_avmm_slave_cmd_width_adapter:out_endofpacket -> alt_pr_0_avmm_slave_burst_adapter:sink0_endofpacket
	...
	wire          alt_pr_0_avmm_slave_agent_rdata_fifo_out_valid;           // alt_pr_0_avmm_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [17:0] alt_pr_0_avmm_slave_agent_rdata_fifo_out_data;            // alt_pr_0_avmm_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          alt_pr_0_avmm_slave_agent_rdata_fifo_out_ready;           // avalon_st_adapter:in_0_ready -> alt_pr_0_avmm_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> alt_pr_0_avmm_slave_agent:rdata_fifo_sink_valid
	wire   [17:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> alt_pr_0_avmm_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // alt_pr_0_avmm_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> alt_pr_0_avmm_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (alt_pr_0_nreset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (alt_pr_0_avmm_slave_agent_m0_address),        // avalon_universal_slave_0.address
		.uav_burstcount         (alt_pr_0_avmm_slave_agent_m0_burstcount),     //                         .burstcount
		.uav_read               (alt_pr_0_avmm_slave_agent_m0_read),           //                         .read
		.uav_write              (alt_pr_0_avmm_slave_agent_m0_write),          //                         .write
		.uav_waitrequest        (alt_pr_0_avmm_slave_agent_m0_waitrequest),    //                         .waitrequest
		.uav_readdatavalid      (alt_pr_0_avmm_slave_agent_m0_readdatavalid),  //                         .readdatavalid
		.uav_byteenable         (alt_pr_0_avmm_slave_agent_m0_byteenable),     //                         .byteenable
		.uav_readdata           (alt_pr_0_avmm_slave_agent_m0_readdata),       //                         .readdata
		.uav_writedata          (alt_pr_0_avmm_slave_agent_m0_writedata),      //                         .writedata
		.uav_lock               (alt_pr_0_avmm_slave_agent_m0_lock),           //                         .lock
		.uav_debugaccess        (alt_pr_0_avmm_slave_agent_m0_debugaccess),    //                         .debugaccess
		.av_address             (alt_pr_0_avmm_slave_address),                 //      avalon_anti_slave_0.address
		.av_write               (alt_pr_0_avmm_slave_write),                   //                         .write
		.av_read                (alt_pr_0_avmm_slave_read),                    //                         .read
		.av_readdata            (alt_pr_0_avmm_slave_readdata),                //                         .readdata
		.av_writedata           (alt_pr_0_avmm_slave_writedata),               //                         .writedata
		.av_waitrequest         (alt_pr_0_avmm_slave_waitrequest),             //                         .waitrequest
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) alt_pr_0_avmm_slave_agent (
		.clk                     (Clock_clk_clk),                                           //             clk.clk
		.reset                   (alt_pr_0_nreset_reset_bridge_in_reset_reset),             //       clk_reset.reset
		.m0_address              (alt_pr_0_avmm_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (alt_pr_0_avmm_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (alt_pr_0_avmm_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (alt_pr_0_avmm_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (alt_pr_0_avmm_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (alt_pr_0_avmm_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (alt_pr_0_avmm_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (alt_pr_0_avmm_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (alt_pr_0_avmm_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (alt_pr_0_avmm_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (alt_pr_0_avmm_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (alt_pr_0_avmm_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (alt_pr_0_avmm_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (alt_pr_0_avmm_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (alt_pr_0_avmm_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (alt_pr_0_avmm_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (alt_pr_0_avmm_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (alt_pr_0_avmm_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (alt_pr_0_avmm_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (alt_pr_0_avmm_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (alt_pr_0_avmm_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (alt_pr_0_avmm_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (alt_pr_0_avmm_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (alt_pr_0_avmm_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (alt_pr_0_avmm_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (alt_pr_0_avmm_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (alt_pr_0_avmm_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (alt_pr_0_avmm_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (alt_pr_0_avmm_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (alt_pr_0_avmm_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (alt_pr_0_avmm_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (alt_pr_0_avmm_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                           //                .error
		.rdata_fifo_src_ready    (alt_pr_0_avmm_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (alt_pr_0_avmm_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (alt_pr_0_avmm_slave_agent_rdata_fifo_src_data),           //                .data
	...
	) alt_pr_0_avmm_slave_agent_rsp_fifo (
		.clk               (Clock_clk_clk),                                        //       clk.clk
		.reset             (alt_pr_0_nreset_reset_bridge_in_reset_reset),          // clk_reset.reset
		.in_data           (alt_pr_0_avmm_slave_agent_rf_source_data),             //        in.data
		.in_valid          (alt_pr_0_avmm_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (alt_pr_0_avmm_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (alt_pr_0_avmm_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (alt_pr_0_avmm_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (alt_pr_0_avmm_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (alt_pr_0_avmm_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (alt_pr_0_avmm_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (alt_pr_0_avmm_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (alt_pr_0_avmm_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) alt_pr_0_avmm_slave_agent_rdata_fifo (
		.clk               (Clock_clk_clk),                                  //       clk.clk
		.reset             (alt_pr_0_nreset_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (alt_pr_0_avmm_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (alt_pr_0_avmm_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (alt_pr_0_avmm_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (alt_pr_0_avmm_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (alt_pr_0_avmm_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (alt_pr_0_avmm_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_router router (
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_router router_001 (
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (alt_pr_0_avmm_slave_agent_rp_ready),          //      sink.ready
		.sink_valid         (alt_pr_0_avmm_slave_agent_rp_valid),          //          .valid
		.sink_data          (alt_pr_0_avmm_slave_agent_rp_data),           //          .data
		.sink_startofpacket (alt_pr_0_avmm_slave_agent_rp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (alt_pr_0_avmm_slave_agent_rp_endofpacket),    //          .endofpacket
		.clk                (Clock_clk_clk),                               //       clk.clk
		.reset              (alt_pr_0_nreset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_router_003 router_003 (
	...
	) alt_pr_0_avmm_slave_burst_adapter (
		.clk                   (Clock_clk_clk),                                           //       cr0.clk
		.reset                 (alt_pr_0_nreset_reset_bridge_in_reset_reset),             // cr0_reset.reset
		.sink0_valid           (alt_pr_0_avmm_slave_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (alt_pr_0_avmm_slave_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (alt_pr_0_avmm_slave_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (alt_pr_0_avmm_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (alt_pr_0_avmm_slave_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (alt_pr_0_avmm_slave_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (alt_pr_0_avmm_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (alt_pr_0_avmm_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (alt_pr_0_avmm_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (alt_pr_0_avmm_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (alt_pr_0_avmm_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (alt_pr_0_avmm_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (Clock_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (Clock_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (Clock_clk_clk),                               //       clk.clk
		.reset               (alt_pr_0_nreset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (Clock_clk_clk),                               //       clk.clk
		.reset               (alt_pr_0_nreset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (Clock_clk_clk),                                           //       clk.clk
		.reset              (alt_pr_0_nreset_reset_bridge_in_reset_reset),             // clk_reset.reset
		.sink_ready         (alt_pr_0_avmm_slave_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (alt_pr_0_avmm_slave_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (alt_pr_0_avmm_slave_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (alt_pr_0_avmm_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (alt_pr_0_avmm_slave_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (alt_pr_0_avmm_slave_rsp_width_adapter_src_valid),         //          .valid
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (Clock_clk_clk),                               //       clk.clk
		.reset              (alt_pr_0_nreset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (Clock_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (Clock_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
	...
	) alt_pr_0_avmm_slave_rsp_width_adapter (
		.clk                  (Clock_clk_clk),                                           //       clk.clk
		.reset                (alt_pr_0_nreset_reset_bridge_in_reset_reset),             // clk_reset.reset
		...
		.out_endofpacket      (alt_pr_0_avmm_slave_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (alt_pr_0_avmm_slave_rsp_width_adapter_src_data),          //          .data
		.out_channel          (alt_pr_0_avmm_slave_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (alt_pr_0_avmm_slave_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (alt_pr_0_avmm_slave_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (alt_pr_0_avmm_slave_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) alt_pr_0_avmm_slave_cmd_width_adapter (
		.clk                  (Clock_clk_clk),                                           //       clk.clk
		.reset                (alt_pr_0_nreset_reset_bridge_in_reset_reset),             // clk_reset.reset
		...
		.out_endofpacket      (alt_pr_0_avmm_slave_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (alt_pr_0_avmm_slave_cmd_width_adapter_src_data),          //          .data
		.out_channel          (alt_pr_0_avmm_slave_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (alt_pr_0_avmm_slave_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (alt_pr_0_avmm_slave_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (alt_pr_0_avmm_slave_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                   // (terminated)
	);

	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (alt_pr_0_nreset_reset_bridge_in_reset_reset),    // in_rst_0.reset
		.in_0_data      (alt_pr_0_avmm_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (alt_pr_0_avmm_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (alt_pr_0_avmm_slave_agent_rdata_fifo_out_ready), //         .ready
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
