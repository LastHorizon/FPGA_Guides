// DE10_standard_hps_partial_reconfiguration_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module DE10_standard_hps_partial_reconfiguration_mm_interconnect_1 (
		input  wire        Clock_clk_clk,                                      //                                   Clock_clk.clk
		input  wire        fpga_master_clk_reset_reset_bridge_in_reset_reset,  // fpga_master_clk_reset_reset_bridge_in_reset.reset
		input  wire        mm_bridge_0_reset_reset_bridge_in_reset_reset,      //     mm_bridge_0_reset_reset_bridge_in_reset.reset
		input  wire [31:0] fpga_master_master_address,                         //                          fpga_master_master.address
		output wire        fpga_master_master_waitrequest,                     //                                            .waitrequest
		input  wire [3:0]  fpga_master_master_byteenable,                      //                                            .byteenable
		input  wire        fpga_master_master_read,                            //                                            .read
		output wire [31:0] fpga_master_master_readdata,                        //                                            .readdata
		output wire        fpga_master_master_readdatavalid,                   //                                            .readdatavalid
		input  wire        fpga_master_master_write,                           //                                            .write
		input  wire [31:0] fpga_master_master_writedata,                       //                                            .writedata
		input  wire [8:0]  mm_bridge_0_m0_address,                             //                              mm_bridge_0_m0.address
	...
	wire          fpga_master_master_translator_avalon_universal_master_0_waitrequest;       // fpga_master_master_agent:av_waitrequest -> fpga_master_master_translator:uav_waitrequest
	wire   [31:0] fpga_master_master_translator_avalon_universal_master_0_readdata;          // fpga_master_master_agent:av_readdata -> fpga_master_master_translator:uav_readdata
	wire          fpga_master_master_translator_avalon_universal_master_0_debugaccess;       // fpga_master_master_translator:uav_debugaccess -> fpga_master_master_agent:av_debugaccess
	wire   [31:0] fpga_master_master_translator_avalon_universal_master_0_address;           // fpga_master_master_translator:uav_address -> fpga_master_master_agent:av_address
	wire          fpga_master_master_translator_avalon_universal_master_0_read;              // fpga_master_master_translator:uav_read -> fpga_master_master_agent:av_read
	wire    [3:0] fpga_master_master_translator_avalon_universal_master_0_byteenable;        // fpga_master_master_translator:uav_byteenable -> fpga_master_master_agent:av_byteenable
	wire          fpga_master_master_translator_avalon_universal_master_0_readdatavalid;     // fpga_master_master_agent:av_readdatavalid -> fpga_master_master_translator:uav_readdatavalid
	wire          fpga_master_master_translator_avalon_universal_master_0_lock;              // fpga_master_master_translator:uav_lock -> fpga_master_master_agent:av_lock
	wire          fpga_master_master_translator_avalon_universal_master_0_write;             // fpga_master_master_translator:uav_write -> fpga_master_master_agent:av_write
	wire   [31:0] fpga_master_master_translator_avalon_universal_master_0_writedata;         // fpga_master_master_translator:uav_writedata -> fpga_master_master_agent:av_writedata
	wire    [2:0] fpga_master_master_translator_avalon_universal_master_0_burstcount;        // fpga_master_master_translator:uav_burstcount -> fpga_master_master_agent:av_burstcount
	...
	wire    [2:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> interrupt_latency_counter_0_avalon_slave_agent:cp_channel
	...
	wire    [2:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire          fpga_master_master_agent_cp_valid;                                         // fpga_master_master_agent:cp_valid -> router_001:sink_valid
	wire  [103:0] fpga_master_master_agent_cp_data;                                          // fpga_master_master_agent:cp_data -> router_001:sink_data
	wire          fpga_master_master_agent_cp_ready;                                         // router_001:sink_ready -> fpga_master_master_agent:cp_ready
	wire          fpga_master_master_agent_cp_startofpacket;                                 // fpga_master_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          fpga_master_master_agent_cp_endofpacket;                                   // fpga_master_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire          router_001_src_valid;                                                      // router_001:src_valid -> fpga_master_master_limiter:cmd_sink_valid
	wire  [103:0] router_001_src_data;                                                       // router_001:src_data -> fpga_master_master_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                      // fpga_master_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [2:0] router_001_src_channel;                                                    // router_001:src_channel -> fpga_master_master_limiter:cmd_sink_channel
	wire          router_001_src_startofpacket;                                              // router_001:src_startofpacket -> fpga_master_master_limiter:cmd_sink_startofpacket
	wire          router_001_src_endofpacket;                                                // router_001:src_endofpacket -> fpga_master_master_limiter:cmd_sink_endofpacket
	wire  [103:0] fpga_master_master_limiter_cmd_src_data;                                   // fpga_master_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	wire          fpga_master_master_limiter_cmd_src_ready;                                  // cmd_demux_001:sink_ready -> fpga_master_master_limiter:cmd_src_ready
	wire    [2:0] fpga_master_master_limiter_cmd_src_channel;                                // fpga_master_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	wire          fpga_master_master_limiter_cmd_src_startofpacket;                          // fpga_master_master_limiter:cmd_src_startofpacket -> cmd_demux_001:sink_startofpacket
	wire          fpga_master_master_limiter_cmd_src_endofpacket;                            // fpga_master_master_limiter:cmd_src_endofpacket -> cmd_demux_001:sink_endofpacket
	wire          rsp_mux_001_src_valid;                                                     // rsp_mux_001:src_valid -> fpga_master_master_limiter:rsp_sink_valid
	wire  [103:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> fpga_master_master_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                     // fpga_master_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                                   // rsp_mux_001:src_channel -> fpga_master_master_limiter:rsp_sink_channel
	wire          rsp_mux_001_src_startofpacket;                                             // rsp_mux_001:src_startofpacket -> fpga_master_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                               // rsp_mux_001:src_endofpacket -> fpga_master_master_limiter:rsp_sink_endofpacket
	wire          fpga_master_master_limiter_rsp_src_valid;                                  // fpga_master_master_limiter:rsp_src_valid -> fpga_master_master_agent:rp_valid
	wire  [103:0] fpga_master_master_limiter_rsp_src_data;                                   // fpga_master_master_limiter:rsp_src_data -> fpga_master_master_agent:rp_data
	wire          fpga_master_master_limiter_rsp_src_ready;                                  // fpga_master_master_agent:rp_ready -> fpga_master_master_limiter:rsp_src_ready
	wire    [2:0] fpga_master_master_limiter_rsp_src_channel;                                // fpga_master_master_limiter:rsp_src_channel -> fpga_master_master_agent:rp_channel
	wire          fpga_master_master_limiter_rsp_src_startofpacket;                          // fpga_master_master_limiter:rsp_src_startofpacket -> fpga_master_master_agent:rp_startofpacket
	wire          fpga_master_master_limiter_rsp_src_endofpacket;                            // fpga_master_master_limiter:rsp_src_endofpacket -> fpga_master_master_agent:rp_endofpacket
	...
	wire    [2:0] fpga_master_master_limiter_cmd_valid_data;                                 // fpga_master_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) fpga_master_master_translator (
		.clk                    (Clock_clk_clk),                                                         //                       clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset),                         //                     reset.reset
		.uav_address            (fpga_master_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (fpga_master_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (fpga_master_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (fpga_master_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (fpga_master_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (fpga_master_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (fpga_master_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (fpga_master_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (fpga_master_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (fpga_master_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (fpga_master_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (fpga_master_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (fpga_master_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (fpga_master_master_byteenable),                                         //                          .byteenable
		.av_read                (fpga_master_master_read),                                               //                          .read
		.av_readdata            (fpga_master_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (fpga_master_master_readdatavalid),                                      //                          .readdatavalid
		.av_write               (fpga_master_master_write),                                              //                          .write
		.av_writedata           (fpga_master_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) fpga_master_master_agent (
		.clk                   (Clock_clk_clk),                                                         //       clk.clk
		.reset                 (mm_bridge_0_reset_reset_bridge_in_reset_reset),                         // clk_reset.reset
		.av_address            (fpga_master_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (fpga_master_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (fpga_master_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (fpga_master_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (fpga_master_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (fpga_master_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (fpga_master_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (fpga_master_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (fpga_master_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (fpga_master_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (fpga_master_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (fpga_master_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (fpga_master_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (fpga_master_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (fpga_master_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (fpga_master_master_agent_cp_ready),                                     //          .ready
		.rp_valid              (fpga_master_master_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (fpga_master_master_limiter_rsp_src_data),                               //          .data
		.rp_channel            (fpga_master_master_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (fpga_master_master_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (fpga_master_master_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (fpga_master_master_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                                      // (terminated)
		.av_writeresponsevalid ()                                                                       // (terminated)
	);
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_router router (
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_router_001 router_001 (
		.sink_ready         (fpga_master_master_agent_cp_ready),             //      sink.ready
		.sink_valid         (fpga_master_master_agent_cp_valid),             //          .valid
		.sink_data          (fpga_master_master_agent_cp_data),              //          .data
		.sink_startofpacket (fpga_master_master_agent_cp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (fpga_master_master_agent_cp_endofpacket),       //          .endofpacket
		.clk                (Clock_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_router_002 router_002 (
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_router_003 router_003 (
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_router_002 router_004 (
	...
	altera_merlin_traffic_limiter #(
		...
		.cmd_src_ready          (fpga_master_master_limiter_cmd_src_ready),         //   cmd_src.ready
		.cmd_src_data           (fpga_master_master_limiter_cmd_src_data),          //          .data
		.cmd_src_channel        (fpga_master_master_limiter_cmd_src_channel),       //          .channel
		.cmd_src_startofpacket  (fpga_master_master_limiter_cmd_src_startofpacket), //          .startofpacket
		.cmd_src_endofpacket    (fpga_master_master_limiter_cmd_src_endofpacket),   //          .endofpacket
		...
		.rsp_src_ready          (fpga_master_master_limiter_rsp_src_ready),         //   rsp_src.ready
		.rsp_src_valid          (fpga_master_master_limiter_rsp_src_valid),         //          .valid
		.rsp_src_data           (fpga_master_master_limiter_rsp_src_data),          //          .data
		.rsp_src_channel        (fpga_master_master_limiter_rsp_src_channel),       //          .channel
		.rsp_src_startofpacket  (fpga_master_master_limiter_rsp_src_startofpacket), //          .startofpacket
		.rsp_src_endofpacket    (fpga_master_master_limiter_rsp_src_endofpacket),   //          .endofpacket
		.cmd_src_valid          (fpga_master_master_limiter_cmd_valid_data)         // cmd_valid.data
	);

	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (Clock_clk_clk),                                 //        clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_cmd_demux_001 cmd_demux_001 (
		.clk                (Clock_clk_clk),                                    //        clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset),    //  clk_reset.reset
		.sink_ready         (fpga_master_master_limiter_cmd_src_ready),         //       sink.ready
		.sink_channel       (fpga_master_master_limiter_cmd_src_channel),       //           .channel
		.sink_data          (fpga_master_master_limiter_cmd_src_data),          //           .data
		.sink_startofpacket (fpga_master_master_limiter_cmd_src_startofpacket), //           .startofpacket
		.sink_endofpacket   (fpga_master_master_limiter_cmd_src_endofpacket),   //           .endofpacket
		.sink_valid         (fpga_master_master_limiter_cmd_valid_data),        // sink_valid.data
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (Clock_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_cmd_mux_001 cmd_mux_001 (
		.clk                 (Clock_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (Clock_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (Clock_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_rsp_demux_001 rsp_demux_001 (
		.clk                (Clock_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (Clock_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (Clock_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE10_standard_hps_partial_reconfiguration_mm_interconnect_1_rsp_mux_001 rsp_mux_001 (
		.clk                 (Clock_clk_clk),                                 //       clk.clk
		.reset               (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
